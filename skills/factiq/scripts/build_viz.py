...
This is the local-output counterpart to the `share_chart` / `share_report`
MCP tools: it never talks to the FactIQ API. You author an HTML file (any technique —
...
def _row_count(value: object) -> int | None:
    ...
    FactIQ MCP payloads usually put rows under "results"; a bare list counts
    directly. Anything else has no meaningful row count.
    """
